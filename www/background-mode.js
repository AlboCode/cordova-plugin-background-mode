...
exports.disableWebViewOptimizations = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'webview', []);
    }
};
...
exports.disableBatteryOptimizations = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'battery', []);
    }
};
...
exports.openAppStartSettings = function (options)
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'appstart', [options]);
    }
};
...
exports.moveToBackground = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'background', []);
    }
};
...
exports.moveToForeground = function()
{
    ...
    {
        cordova.exec(null, null, 'BackgroundExt', 'foreground', []);
    }
};
...
exports.excludeFromTaskList = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'tasklist', []);
    }
};
...
exports.isScreenOff = function (fn)
{
    if (this._isAndroid)
    {
        cordova.exec(fn, null, 'BackgroundExt', 'dimmed', []);
    }
    else
    {
        fn(undefined);
...
exports.wakeUp = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'wakeup', []);
    }
};
...
exports.unlock = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundExt', 'unlock', []);
    }
};
